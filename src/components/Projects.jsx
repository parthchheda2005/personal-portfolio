...
function Projects({ textGradientColor }) {
  ...
  return (
    <div id="projects" className="text-white max-width-[1200px] mx-auto">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 mx-7 items-center">
        {images.map((el) => (
          <div className="transform transition-all duration-300 hover:scale-105 overflow-hidden shadow-lg shadow-neutral-900 group container rounded-md flex justify-center items-center max-h-[250px] bg-cover relative">
            <img src={el.img} alt="movie webapp" />
            <div className="opacity-0 group-hover:opacity-90 bg-neutral-600 absolute inset-0 flex justify-center items-center">
